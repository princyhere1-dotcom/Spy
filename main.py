...
def build_game_status_message(game: GameState) -> str:
    ...
    message = (
        "💬 Hints:\n\n"
        f"{hints_section}"
        "🗞 Give hints about your word — but don't let the Spy know real word"
    )
    return message
...
async def begin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Apply group round time override if set via /settings
    ...
    game_started_text = (
        "🕵️‍♂️ Game has been started.\n\n"
        f"🎯 𝗥𝗼𝘂𝗻𝗱 - {game.current_round}  \n"
        f"👥 𝗣𝗹𝗮𝘆𝗲𝗿𝘀 𝗔𝗹𝗶𝘃𝗲 - {alive_count}\n\n"
        "━━━━━━━━━━━━━━━\n"
        "💬 𝗛𝗶𝗻𝘁𝘀:\n"
        "🔹 No hints yet\n\n"
        "⌨️ To give hint, use /hint <text>\n\n"
        "🕶 No one is innocent — the Spy is choosing his next victim. 🔪"
    )
